...
public final class AllergenValues {
    ...
    public final static String GLUTEN = "Zboża zawierające gluten, tj. pszenica (w tym orkisz i pszenica khorasan), żyto, jęczmień, owies lub ich odmiany hybrydowe, a także produkty pochodne, z wyjątkiem:\n" +
    ...
    public final static String SHELLFISH = "Skorupiaki i produkty pochodne.";
    public final static String EGG = "Jaja i produkty pochodne.";
    public final static String FISH = " Ryby i produkty pochodne, z wyjątkiem:\n" +
    ...
    public final static String PEANUTS = "Orzeszki ziemne (arachidowe) i produkty pochodne.";
    public final static String SOY = "Soja i produkty pochodne, z wyjątkiem:\n" +
